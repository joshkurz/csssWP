...
location.hash = "intro";
	...
	for(var i=0; i<this.slides.length; i++) {
		...
		this.order.push(imported? +imported.getAttribute('data-index') : i);
			...
			p.className = 'onscreen-navPrev';
			p.textContent = 'Prev ';
			p.type = 'button';
			p.onclick = function() { me.previous(); }
...
})(document.head || document.getElementsByTagName('head')[0], document.body || document.getElementsByTagName('body')[0], document.documentElement);
